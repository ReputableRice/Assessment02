            ...
            <div className={styles.main}>
...

                {
                    Object.keys(fruitNames).map(item => (
                        ...
                        >
                            <h1 className={styles.fruitTitle}>{fruitNames[item].fruit}</h1>
                            <p
